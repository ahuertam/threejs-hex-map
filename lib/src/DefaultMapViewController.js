define(["require", "exports", "./coords", "three"], function (require, exports, coords_1, three_1) {
    ...
    var Controller = /** @class */ (function () {
        ...
        Controller.prototype.showDebugInfo = function () {
            ...
            this.debugText.innerHTML = "Selected Tile: QR(" + tileQR.q + ", " + tileQR.r + ", Terrain: " + (tile ? tile.terrain : "Not selected") + "),\n            <br>XY(" + tileXYZ.x.toFixed(2) + ", " + tileXYZ.y.toFixed(2) + ")\n            <br>Camera Looks At: XYZ(" + camPos.x.toFixed(2) + ", " + camPos.y.toFixed(2) + ", " + camPos.z.toFixed(2) + ")";
        };

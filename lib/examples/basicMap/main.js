...
define(["require", "exports", "view", "input", "./util", "../../src/MapView", "../../src/Grid"], function (require, exports, view_1, input_1, util_1, MapView_1, Grid_1) {
    "use strict";
    ...
    function replaceMap(mapToChange) {
        ...
        var mapGrid = new Grid_1.default(mapToChange.map._width, mapToChange.map._height);
        var mapGridGenerated = mapGrid.init(mapToChange.map.data);
